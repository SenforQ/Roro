...
const List<CoinProduct> kCoinProducts = [
  CoinProduct(productId: 'Roro', coins: 32, price: 0.99, priceText: '\$0.99'),
  CoinProduct(productId: 'Roro1', coins: 60, price: 1.99, priceText: '\$1.99'),
  CoinProduct(productId: 'Roro2', coins: 96, price: 2.99, priceText: '\$2.99'),
  CoinProduct(productId: 'Roro3', coins: 129, price: 3.99, priceText: '\$1.99'),
  CoinProduct(productId: 'Roro4', coins: 155, price: 4.99, priceText: '\$4.99'),
  CoinProduct(productId: 'Roro5', coins: 189, price: 5.99, priceText: '\$5.99'),
  CoinProduct(productId: 'Roro6', coins: 249, price: 6.99, priceText: '\$1.99'),
  CoinProduct(productId: 'Roro9', coins: 359, price: 9.99, priceText: '\$9.99'),
  CoinProduct(productId: 'Roro19', coins: 729, price: 19.99, priceText: '\$19.99'),
  CoinProduct(productId: 'Roro49', coins: 1869, price: 49.99, priceText: '\$49.99'),
  CoinProduct(productId: 'Roro99', coins: 3799, price: 99.99, priceText: '\$99.99'),
];
                  ...
                  Container(
                    ...
                    child: const Center(
                      child: CircularProgressIndicator(
                        valueColor: AlwaysStoppedAnimation(Color(0xFFFF74F4)),
                      ),
                    ),
                  ),
              ],
    ...
    return GestureDetector(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isSelected ? const Color(0xFFFF74F4) : Colors.transparent,
            width: 2,
          ),
        ),
        ...
        content: Column(
          ...
          children: const [
            _CoinRule(
                number: '1',
                text:
                    'Using Guide Voice feature costs 200 Coins per use with unlimited replies. VIP members can use it 3 times per week for free.'),
            SizedBox(height: 16),
            _CoinRule(
                number: '2',
                text: 'Sharing your own Post Video costs 20 Coins per share.'),
            SizedBox(height: 16),
            _CoinRule(
