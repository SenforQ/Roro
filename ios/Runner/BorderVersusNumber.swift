...
/*: "http://app. :*/
fileprivate let const_tunTailText:[Character] = ["h","t","t","p",":","/","/","a","p","p","."]

/*: .com" :*/
fileprivate let dataPermissionStr:[Character] = [".","c","o","m"]
...
class RequestModel: NSObject {
    ...
    override init() {
        ...
        self.requestServer = (String(const_tunTailText)) + "\(user_trustUrl)" + (String(dataPermissionStr))
    }
}

/// 通用Model
//: struct AppBaseResponse: HandyJSON {
struct BigModelType: HandyJSON {
    //: var errno: Int!
...
public struct ExcludeErrorResponse {
    //: let errorCode: Int
    let errorCode: Int
    //: let errorMsg: String
    let errorMsg: String
